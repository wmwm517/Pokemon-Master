	...
	while (isRunning)
	{
		for (int i=0; i<2; i++)
		{
			...
			if (i == 0) {
				...
				cout << "|     - Count: " << left << setw(14) << p1->getSkillCnt(0) << "(" << p1->getSkillMaxCnt(0) << ")" << "|";
				cout << "     - Count: " << left << setw(14) << p2->getSkillCnt(0) << "(" << p2->getSkillMaxCnt(0) << ")" << "|" << endl;
				...
				cout << "|     - Count: " << left << setw(14) << p1->getSkillCnt(1) << "(" << p1->getSkillMaxCnt(1) << ")" << "|";
				cout << "     - Count: " << left << setw(14) << p2->getSkillCnt(1) << "(" << p2->getSkillMaxCnt(1) << ")" << "|" << endl;
				...
				cout << "|     - Count: " << left << setw(14) << p1->getSkillCnt(2) << "(" << p1->getSkillMaxCnt(2) << ")" << "|";
				cout << "     - Count: " << left << setw(14) << p2->getSkillCnt(2) << "(" << p2->getSkillMaxCnt(2) << ")" << "|" << endl;
				...
				cout << "|     - Count: " << left << setw(14) << p1->getSkillCnt(3) << "(" << p1->getSkillMaxCnt(3) << ")" << "|";
				cout << "     - Count: " << left << setw(14) << p2->getSkillCnt(3) << "(" << p2->getSkillMaxCnt(3) << ")" << "|" << endl;
				cout << "+------------------------------+------------------------------+" << endl;
