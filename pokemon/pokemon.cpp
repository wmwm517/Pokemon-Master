	...
	while (isRunning)
	{
		for (int i=0; i<2; i++)
		{
			...
			if (i%2 == 0) {
				...
				cout << "+------------------------------+------------------------------+" << endl;
				cout << "| " << p1->getName() <<" (*)" << setw(25) << "| " << p2->getName() << setw(29) <<"|" << endl;
				cout << "| Type: "<< p1->getType() << setw(23) << "| Type: " << p2->getType() << setw(23) << "|"  << endl;
				cout << "| HP: " << p1->getHP() << setw(25) << "| HP: " << p2->getHP() << setw(25) << "|" << endl;
				cout << "+------------------------------+------------------------------+" << endl;
				cout << "| Latest Skill: " << p1->getLastskill() << setw(15) << "| Latest Skill: " << p2->getLastskill() << setw(15) << "|" << endl;
				cout << "| " << p1->getLasteffect() << setw(29) << "| " << p2->getLasteffect() << setw(29) << "|" << endl;
				cout << "+------------------------------+------------------------------+" << endl;
				cout << "| (0) " << p1->getSkillName(0) << setw(25) << "| (0) " << p2->getSkillName(0) << setw(25) << "|" << endl;
				cout << "|     - Type: " << p1->getSkillType(0) << setw(17) << "|     - Type: " << p2->getSkillType(0) << setw(17) << "|" << endl;
				cout << "|     - Damage: " << p1->getSkillDamage(0) << setw(15) <<"|     - Damage: " << p2->getSkillDamage(0) << setw(15) << "|" << endl;
				cout << "|     - Count: " << p1->getSkillCnt(0) << "(" << p1->getSkillMaxCnt(0) << ")" << setw(14) << "|     - Count: " << p2->getSkillCnt(0) << "(" << p2->getSkillMaxCnt(0) << ")" << setw(14) << "|" << endl;
				cout << "| (1) " << p1->getSkillName(1) << setw(25) << "| (1) " << p2->getSkillName(1) << setw(25) << "|" << endl;
				cout << "|     - Type: " << p1->getSkillType(1) << setw(17) << "|     - Type: " << p2->getSkillType(1) << setw(17) << "|" << endl;
				cout << "|     - Damage: " << p1->getSkillDamage(1) << setw(15) <<"|     - Damage: " << p2->getSkillDamage(1) << setw(15) << "|" << endl;
				cout << "|     - Count: " << p1->getSkillCnt(1) << "(" << p1->getSkillMaxCnt(1) << ")" << setw(14) << "|     - Count: " << p2->getSkillCnt(1) << "(" << p2->getSkillMaxCnt(1) << ")" << setw(14) << "|" << endl;
				cout << "| (2) " << p1->getSkillName(2) << setw(25) << "| (2) " << p2->getSkillName(2) << setw(25) << "|" << endl;
				cout << "|     - Type: " << p1->getSkillType(2) << setw(17) << "|     - Type: " << p2->getSkillType(2) << setw(17) << "|" << endl;
				cout << "|     - Damage: " << p1->getSkillDamage(2) << setw(15) <<"|     - Damage: " << p2->getSkillDamage(2) << setw(15) << "|" << endl;
				cout << "|     - Count: " << p1->getSkillCnt(2) << "(" << p1->getSkillMaxCnt(2) << ")" << setw(14) << "|     - Count: " << p2->getSkillCnt(2) << "(" << p2->getSkillMaxCnt(2) << ")" << setw(14) << "|" << endl;
				cout << "| (3) " << p1->getSkillName(3) << setw(25) << "| (3) " << p2->getSkillName(3) << setw(25) << "|" << endl;
				cout << "|     - Type: " << p1->getSkillType(3) << setw(17) << "|     - Type: " << p2->getSkillType(3) << setw(17) << "|" << endl;
				cout << "|     - Damage: " << p1->getSkillDamage(3) << setw(15) <<"|     - Damage: " << p2->getSkillDamage(3) << setw(15) << "|" << endl;
				cout << "|     - Count: " << p1->getSkillCnt(3) << "(" << p1->getSkillMaxCnt(3) << ")" << setw(14) << "|     - Count: " << p2->getSkillCnt(3) << "(" << p2->getSkillMaxCnt(3) << ")" << setw(14) << "|" << endl;
				cout << "+------------------------------+------------------------------+" << endl;
				...
				cout << "| 2024-02 Object-Oriented Programming Pokemon Master          |" << endl;
				cout << "+------------------------------+------------------------------+" << endl;
				cout << "| " << p1->getName() << setw(29) << "| " << p2->getName() << " (*)" << setw(25) <<"|" << endl;
				cout << "| Type: "<< p1->getType() << setw(23) << "| Type: " << p2->getType() << setw(23) << "|"  << endl;
				cout << "| HP: " << p1->getHP() << setw(25) << "| HP: " << p2->getHP() << setw(25) << "|" << endl;
				cout << "+------------------------------+------------------------------+" << endl;
				cout << "| Latest Skill: " << p1->getLastskill() << setw(15) << "| Latest Skill: " << p2->getLastskill() << setw(15) << "|" << endl;
